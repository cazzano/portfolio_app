...
const projects = [
  {
    ...
    tags: ['Nextjs', 'Flask', 'RESTAPIS + WebSockets (Coming Soons)', 'Flutter'],
  ...
  },
  {
    ...
    tags: ['Go Lang', 'Pyqt6 (Python)', 'Flutter', 'GTK 3/4 (Python)'],
    liveUrl: '#',
  ...
  },
  {
    ...
    image: 'https://placehold.co/600x400.png',
    aiHint: 'code screen',
    tags: ['Go Lang', 'Rust', 'Encrypted Security', 'Linux Focused'],
    liveUrl: '#',
